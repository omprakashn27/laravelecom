            ...
            $.ajax({
                ...
                success: function (response) {
                    var options = {
                        ...
                        "amount": response.price, //1 * 100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
                        "currency": "INR",
                            ...
                            $.ajax({
                                ...
                                success: function (responseb) {
                                    if (responseb.status == 200) {
                                        ...
                                        swal("Congratulations", "Your order has been placed!", "success").then( (value) => {
                                       if (value) {
